                      ...
                      <div className="flex flex-col gap-4 my-10">
                        ...
                        <div className="flex justify-center items-center bg-gray-200 p-10 my-3">
                          <div className="grid grid-cols-2 gap-10">
                            ...
                            <div className="flex flex-col justify-center items-center gap-3">
                              <IoLogoWhatsapp
                                className="cursor-default p-3 bottom-20 right-4 h-16 w-16 text-blue-500 z-50 bg-white rounded-full"
                              />
                              <span className="text-gray-700">Whatsapp</span>
                            </div>
                            <div className="flex flex-col justify-center items-center gap-3">
                              <a href="https://www.instagram.com/Tonz606" target="_blank" rel="noreferrer" className="flex flex-col justify-center items-center gap-3">
                                <FaInstagram
                                  className="cursor-pointer hover:bg-blue-800 active:bg-blue-900 p-3 bottom-20 right-4 h-16 w-16 text-blue-500 z-50 bg-white rounded-full"
                                />
