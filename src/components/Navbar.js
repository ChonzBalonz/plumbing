        ...
        <div className="flex md:space-x-20 space-x-5">
          <div className="flex space-x-3 items-center">
            ...
            <div className="flex flex-col justify-center items-baseline">
              ...
              <a href="mailto:kasbassnigenterprises@gmail.com" className="text-sm grey dark:text-gray-400">@kasbassnigenterprises@gmail.com</a>
            </div>
          </div>
          <div className="hidden md:flex space-x-3 items-center">
            ...
            <div className="flex flex-col justify-center items-baseline">
                ...
                <a href="tel:+2348147603570" className="text-sm grey dark:text-gray-400">(+234) 814 760 3570</a>
            </div>
          </div>
        </div>
      </div>
