    ...
    <header>
      <div className="flex">
        <div className="bg-blue-500 w-1/3 p-3 flex items-center px-5">
          <span className="text-white font-bold text-[13px] md:text-[18px] company">WebsitesWithToni Enterprises</span>
        </div>
      ...
      <div className="flex justify-center md:justify-between items-center py-2 px-3 md:px-10 bg-white dark:bg-gray-800 transition-colors duration-300">
        <div className="md:flex md:flex-col items-baseline hidden ">
          ...
          <p className="text-sm dark:text-gray-300">Professional Plumber</p>
        </div>
        <div className="flex md:space-x-20 space-x-5">
          <div className="flex space-x-3 items-center">
            ...
            <div className="flex flex-col justify-center items-baseline">
              <p className="font-bold dark:text-gray-300">Email us</p>
              <a href="mailto:websiteswithtoni@email.com" className="text-sm grey dark:text-gray-400">websiteswithtoni@email.com</a>
            </div>
          </div>
          <div className="hidden md:flex space-x-3 items-center">
            ...
            <div className="flex flex-col justify-center items-baseline">
                <p className="font-bold dark:text-gray-300">Call us on</p>
                <a href="tel:5551234567" className="text-sm grey dark:text-gray-400">(555) 123-4567</a>
            </div>
          </div>
        </div>
      </div>
